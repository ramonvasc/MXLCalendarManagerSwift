...
Pod::Spec.new do |s|
  ...
  s.version          = '1.0.0'
  s.summary          = 'A short description of MXLCalendarManagerSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'ramonvasc' => 'ramonvasc@gmail.com' }
  ...
  # s.resource_bundles = {
  #   'MXLCalendarManagerSwift' => ['MXLCalendarManagerSwift/Assets/*.png']
  # }
